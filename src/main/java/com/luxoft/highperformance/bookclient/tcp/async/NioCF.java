...
public class NioCF {
    ...
    public static CompletableFuture<ByteBuffer> readBuffer(int size, AsynchronousSocketChannel clientChannel) {
        ByteBuffer buffer = ByteBuffer.allocate(size);
        CompletableFuture<ByteBuffer> futureMsg = new CompletableFuture<>();
